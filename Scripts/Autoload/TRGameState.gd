...
func _active_population_for_group(group_id: String) -> int:
	# Direct population lookup. Do not call active_population_by_group() here,
	# because active_population_by_group() itself iterates through population and
	# previously called this helper indirectly through housing summaries/labour previews,
